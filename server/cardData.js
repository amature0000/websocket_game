...
const CARDS = {
  ...
  'atk_suppress': { id: 'atk_suppress', name: '제압 사격', type: CARD_TYPES.ATTACK, value: 5, effect: { target_draw: -1 }, description: '5의 피해를 줍니다. 적중 시 대상은 다음 턴 카드를 1장 덜 뽑습니다.' },
  'atk_throw': { id: 'atk_throw', name: '집어던지기', type: CARD_TYPES.ATTACK, value: 5, effect: { actor_draw: 1 }, description: '5의 피해를 줍니다. 카드를 1장 뽑습니다.' },
  'atk_tracer': { id: 'atk_tracer', name: '예광탄', type: CARD_TYPES.ATTACK, value: 5, effect: { actor_range: 999 }, description: '5의 피해를 줍니다. 이번 턴에 사용하는 다음 공격 카드는 대응할 수 없습니다.' },
  ...
  'def_4': { id: 'def_4', name: '감자 포대', type: CARD_TYPES.SKILL, effect: { actor_defense: 15, actor_discard: 1 }, description: '15의 방어력을 얻습니다. 카드를 한 장 버립니다.' },
